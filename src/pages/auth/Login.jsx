    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-dark relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center text-white">
            <h1 className="text-5xl font-extrabold mb-6 tracking-tight">Order<span className="text-primary">Now</span></h1>
            <p className="text-xl text-gray-300 max-w-md mx-auto leading-relaxed">The all-in-one platform to manage your restaurant, deliveries, and growth.</p>
        </div>
      </div>
            ...
            <form className="space-y-6 animate-slide-in-right" onSubmit={handleSubmit(onVerifyOTP)}>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <button type="button" onClick={() => setStep(1)} className="text-xs text-primary font-medium hover:underline">Edit Email</button>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input-field pl-12 tracking-[0.5em] text-center font-bold text-lg"
                    placeholder="••••••"
                    maxLength={6}
                    autoFocus
                  />
